...
require(["config"], function () {
  require(["jquery", "header", "template", "footer", "jquerycookie"], function ($, header, template, footer, jquerycookie) {
    new Promise(function (resolve, reject) {
      ...
      var cart = $.cookie("cart"); //console.log(cart);
      ...
      var html = template("shopcart-template", {
        products: arr
      });
      $("#prod").html(html); //console.log(cart);
      //cookie封装

      function save() {
        var products = JSON.stringify(arr); //console.log(products);
      ...
      $(".del i").click(function () {
        var id = $(this).parent().parent().attr("data-id"); //console.log(id);
      ...
      $(".add").click(function () {
        var num = $(this).prev().val(); //console.log(num);
      ...
      function total() {
        ...
        $(".ck_sig:checked").each(function (index, item) {
          ...
          sums += price * amount; //console.log(sums);
        }); //计算商品的金额与合计
