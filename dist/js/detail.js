    ...
    new Promise(function (resolve, reject) {
      ...
      $.ajax({
        ...
        success: function success(res) {
          //console.log(res);
          var html = template("pro-detail", {
            products: res.product
          }); //console.log(html);

          $(".detail-box").html(html); //点击小图让大图出现
          //点击切换文字和图片
          ...
          var _id = res.product.id; //console.log(_id);

          var _img = $("#smallimg").attr("src"); //console.log(_img);


          var _title = $("#title").html(); //console.log(_title);


          var _price = $(".detail-price").html(); //console.log(_price);
          ...
          if (cart) {
            arr = JSON.parse(cart); //console.log(arr);
          }
          ...
          $(".detail-btn-addcard").click(function () {
            ...
            var products = JSON.stringify(arr); //console.log(JSON.stringify(cart));
            //查询cookie中是否存在已选购的商品
